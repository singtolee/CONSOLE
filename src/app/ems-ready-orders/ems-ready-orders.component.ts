...
@Component({
  selector: 'app-ems-ready-orders',
  templateUrl: './ems-ready-orders.component.html',
  styleUrls: ['./ems-ready-orders.component.css']
})
export class EmsReadyOrdersComponent implements OnInit {
